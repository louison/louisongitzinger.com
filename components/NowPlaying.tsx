...
export default function NowPlaying() {
    ...
    return (
        <div className="flex flex-row space-x-0 sm:space-x-2 justify-center">
            <svg className="h-4 w-4 mt-1 mr-1 sm:mr-0" viewBox="0 0 168 168">
                <path
                    fill="#1ED760"
            ...
            <div className="inline-flex flex-row truncate">
                {data?.songUrl ? (
                    <a
